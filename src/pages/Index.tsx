      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-20 h-20 md:w-24 md:h-24 bg-gradient-to-r from-primary to-primary-glow rounded-full flex items-center justify-center shadow-lg">
      ...
      <footer className="bg-secondary/50 py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-4 text-xs text-muted-foreground">
            © 2024 WhatsApp Group. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
