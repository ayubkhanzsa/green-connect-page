  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="bg-black hover:bg-gray-800 text-white p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 relative w-14 h-14 flex items-center justify-center"
      >
        <img 
          src="/lovable-uploads/308ad7e9-46bf-4db5-af45-ab8964cbb093.png" 
          alt="Support" 
